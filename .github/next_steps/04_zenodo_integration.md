...
2. Your package will get a DOI only after you make a release. Create a new release as described in [README.dev.md](https://github.com/mexca/my-python-project/blob/main/README.dev.md#33-github)
